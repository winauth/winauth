...
### _Notice about binary distributions on Google Code_ ###

_Google code has [changed their policy](http://google-opensource.blogspot.com/2013/05/a-change-to-google-code-download-service.html) with regard to downloads so all future pre-built downloads will be available at [WinAuth.com](https://winauth.com)_
